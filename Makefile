...
bridges_kmer_strong_multi_tiny: kmer_hash_19 
	...
	upcxx-run -N 8 -n 255 -shared-heap 50% ./kmer_hash_19 /pylon5/sc5fp4p/bbrock/hw3-datasets/smaller/tiny.txt data >> ./output/multi/kmer_strong_multi_tiny.dat
...
bridges_kmer_strong_multi_small: kmer_hash_19 
	...
	upcxx-run -N 8 -n 255 -shared-heap 50% ./kmer_hash_19 /pylon5/sc5fp4p/bbrock/hw3-datasets/smaller/small.txt data >> ./output/multi/kmer_strong_multi_small.dat
...
bridges_kmer_strong_multi_test: kmer_hash_19 
	...
	upcxx-run -N 8 -n 255 -shared-heap 50% ./kmer_hash_19 /pylon5/sc5fp4p/bbrock/hw3-datasets/test.txt data >> ./output/multi/kmer_strong_multi_test.dat
...
bridges_kmer_strong_multi_large: kmer_hash_51
	...
	upcxx-run -N 8 -n 255 -shared-heap 50% ./kmer_hash_51 /pylon5/sc5fp4p/bbrock/hw3-datasets/large.txt data >> ./output/multi/kmer_strong_multi_large.dat
...
bridges_kmer_strong_multi_human-chr14-synthetic.dat: kmer_hash_51
	...
	upcxx-run -N 8 -n 255 -shared-heap 50% ./kmer_hash_51 /pylon5/sc5fp4p/bbrock/hw3-datasets/human-chr14-synthetic.txt data >> ./output/multi/kmer_strong_multi_human-chr14-synthetic.dat
...
bridges_kmer_weak_multi_1: kmer_hash_19
	...
	upcxx-run -N 8 -n 255 -shared-heap 50% ./kmer_hash_19 /pylon5/sc5fp4p/bbrock/hw3-datasets/smaller/small.txt data >> ./output/multi/kmer_weak_multi_1.dat
...
bridges_kmer_weak_multi_2: kmer_hash_19 kmer_hash_51
	...
	upcxx-run -N 8 -n 255 -shared-heap 50% ./kmer_hash_51 /pylon5/sc5fp4p/bbrock/hw3-datasets/human-chr14-synthetic.txt data >> ./output/multi/kmer_weak_multi_2.dat
